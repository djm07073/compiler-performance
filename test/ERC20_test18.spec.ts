...
import { ERC20_TEST18 } from "../typechain-types";
describe("CASE18: Deduplicate Off, CSE Off", () => {
  let erc20: ERC20_TEST18;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST18"))
      .deploy()
