...
import { ERC20_TEST16 } from "../typechain-types";
describe("CASE16: More runs, CSE On", () => {
  let erc20: ERC20_TEST16;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST16"))
      .deploy()
