...
import { ERC20_TEST10 } from "../typechain-types";
describe("CASE10: No Optimizations", () => {
  let erc20: ERC20_TEST10;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST10"))
      .deploy()
