...
import { ERC20_TEST11 } from "../typechain-types";
describe("CASE11: More runs for accuracy", () => {
  let erc20: ERC20_TEST11;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST11"))
      .deploy()
