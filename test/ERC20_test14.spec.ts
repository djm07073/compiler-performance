...
import { ERC20_TEST14 } from "../typechain-types";
describe("CASE14: OrderLiterals Off", () => {
  let erc20: ERC20_TEST14;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST14"))
      .deploy()
