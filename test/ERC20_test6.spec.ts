...
import { ERC20_TEST5 } from "../typechain-types";
describe("CASE6: Minimal Optimization", () => {
  let erc20: ERC20_TEST5;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST6"))
      .deploy()
