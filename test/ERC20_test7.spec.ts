...
import { ERC20_TEST7 } from "../typechain-types";
describe("CASE7: Minimal Optimization", () => {
  let erc20: ERC20_TEST7;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST7"))
      .deploy()
