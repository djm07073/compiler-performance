...
import { ERC20_TEST17 } from "../typechain-types";
describe("CASE17: No jumpdestRemover, CSE On", () => {
  let erc20: ERC20_TEST17;
  it("Deploy ERC20 & Mint 100 Tokens", async () => {
    erc20 = await (await ethers.getContractFactory("ERC20_TEST17"))
      .deploy()
